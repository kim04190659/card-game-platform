...
| ID | ゲーム名 | カード数 | 実装日 | ステータス |
|----|---------|---------|--------|----------|
| city-dx | 自治体DX推進ゲーム | 18 | Phase 3 | ✅ 完成 |
| robot-solution | ロボットソリューション創出ゲーム | 18 | Phase 4 | ✅ 完成 |
| it-operations-excellence | IT運用エクセレンスゲーム | 18 | Phase 4 | ✅ 完成 |
| it-security-solution | ITセキュリティソリューション創出ゲーム | 32 | Phase 7 | ✅ 完成 |
